 ...
 */
package com.birdstudio.mars.container.page.pages;
...
public class SystemPageHandler implements PageHandler {
	...
	public Page handle(URL url) {
		...
		row = new ArrayList<String>();
		row.add("Time");
		row.add(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS Z")
				.format(new Date()));
		rows.add(row);

		return new Page("System", "System",
				new String[] { "Property", "Value" }, rows);
	}
