 ...
 */
package com.birdstudio.mars.container;
...
public class Main {
	...
	public static final String CONTAINER_KEY = "mars.container";

	public static final String SHUTDOWN_HOOK_KEY = "mars.shutdown.hook";
	...
	public static void main(String[] args) {
		try {
			...
			for (Container container : containers) {
				container.start();
				logger.info("Mars " + container.getClass().getSimpleName()
						+ " started!");
			}
			System.out.println(new SimpleDateFormat("[yyyy-MM-dd HH:mm:ss]")
					.format(new Date()) + " Mars service server started!");
