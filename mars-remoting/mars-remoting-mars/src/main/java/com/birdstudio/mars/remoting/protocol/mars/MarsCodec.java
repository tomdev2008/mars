...
import static com.birdstudio.mars.remoting.protocol.mars.CallbackServiceCodec.encodeInvocationArgument;
...
import com.birdstudio.eirene.utils.io.Bytes;
import com.birdstudio.eirene.utils.io.UnsafeByteArrayInputStream;
...
import com.birdstudio.eirene.utils.serialize.ObjectOutput;
...
import com.birdstudio.mars.network.exchange.codec.ExchangeCodec;
...
public class MarsCodec extends ExchangeCodec implements Codec {

	private static final Logger log = LoggerFactory.getLogger(MarsCodec.class);

	public static final String NAME = "mars";

	public static final String MARS_VERSION = Version.getVersion(
			MarsCodec.class, Version.getVersion());
	...
	protected Object decodeBody(Channel channel, InputStream is, byte[] header)
		...
		Serialization s = CodecSupport
				.getSerialization(channel.getUrl(), proto);
		// get request id.
	...
	protected void encodeRequestData(Channel channel, ObjectOutput out,
		...
		out.writeUTF(inv
				.getAttachment(Constants.MARS_VERSION_KEY, MARS_VERSION));
