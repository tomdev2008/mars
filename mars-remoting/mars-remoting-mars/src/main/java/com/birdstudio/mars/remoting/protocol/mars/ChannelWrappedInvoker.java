...
import com.birdstudio.mars.network.exchange.support.header.HeaderExchangeClient;
import com.birdstudio.mars.network.transport.ClientDelegate;
...
class ChannelWrappedInvoker<T> extends AbstractInvoker<T> {
    ...
    public static class ChannelWrapper extends ClientDelegate {
        ...
        public ChannelWrapper(Channel channel) {
            this.channel = channel;
            this.url = channel.getUrl().addParameter("codec", MarsCodec.NAME);
        }
