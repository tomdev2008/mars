...
class CallbackServiceCodec {
    ...
    private static final MarsProtocol protocol = MarsProtocol.getDubboProtocol();
    ...
    private static String exportOrunexportCallbackService(Channel channel, URL url, Class clazz, Object inst, Boolean export) throws IOException{
        ...
        //增加方法，变于方法检查，自动降级(见mars protocol)
        ...
        URL exporturl = new URL(MarsProtocol.NAME, channel.getLocalAddress().getAddress().getHostAddress(), channel.getLocalAddress().getPort(), clazz.getName()+"."+instid, tmpmap);
    ...
    public static Object decodeInvocationArgument(Channel channel, RpcInvocation inv, Class<?>[] pts, int paraIndex, Object inObject) throws IOException{
        ...
        URL url = null ;
        try {
            url = MarsProtocol.getDubboProtocol().getInvoker(channel, inv).getUrl();
