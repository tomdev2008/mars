...
import com.birdstudio.eirene.utils.store.DataStore;
import com.birdstudio.eirene.utils.ExecutorUtil;
...
import com.birdstudio.mars.network.transport.dispatcher.ChannelHandlers;
...
public abstract class AbstractClient extends AbstractEndpoint implements Client {
    ...
    protected static final String CLIENT_THREAD_POOL_NAME  ="MarsClientHandler";
    
    private static final AtomicInteger CLIENT_THREAD_POOL_ID = new AtomicInteger();

    private final Lock            connectLock = new ReentrantLock();
    
    private static final ScheduledThreadPoolExecutor reconnectExecutorService = new ScheduledThreadPoolExecutor(2, new NamedThreadFactory("MarsClientReconnectTimer", true));
        ...
        try {
            ...
            if (! isConnected()) {
                throw new RemotingException(this, "Failed connect to server " + getRemoteAddress() + " from " + getClass().getSimpleName() + " "
                                            + NetUtils.getLocalHost() + " using mars version " + Version.getVersion()
