 ...
 */
package com.birdstudio.mars.network.exchange.codec;
...
import com.birdstudio.eirene.utils.io.StreamUtils;
...
import com.birdstudio.mars.network.buffer.ChannelBufferInputStream;
import com.birdstudio.mars.network.buffer.ChannelBufferOutputStream;
import com.birdstudio.mars.network.exchange.Request;
import com.birdstudio.mars.network.exchange.Response;
import com.birdstudio.mars.network.exchange.support.DefaultFuture;
import com.birdstudio.mars.network.telnet.codec.TelnetCodec;
		...
		try {
			...
			if (!res.isEvent() && res.getStatus() != Response.BAD_RESPONSE) {
				try {
					...
					logger.warn("Failed to send bad_response info back: " + res
	...
	protected Object decodeRequestData(ObjectInput in) throws IOException {
		try {
			...
			throw new IOException(
					StringUtils.toString("Read object failed.", e));
		}
	}
