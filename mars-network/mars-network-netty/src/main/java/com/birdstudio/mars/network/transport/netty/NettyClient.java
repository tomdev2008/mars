...
import com.birdstudio.mars.network.transport.AbstractClient;
...
public class NettyClient extends AbstractClient {
	...
	private static final ChannelFactory channelFactory = new NioClientSocketChannelFactory(
			...
			Executors.newCachedThreadPool(new NamedThreadFactory(
					"NettyClientWorker", true)), Constants.DEFAULT_IO_THREADS);
	...
	@Override
	protected com.birdstudio.mars.network.Channel getChannel() {
		Channel c = channel;
