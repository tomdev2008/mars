 ...
 */
package com.birdstudio.mars.monitor.support;
...
import com.birdstudio.mars.monitor.Monitor;
...
public class MonitorFilter implements Filter {
	...
	private void collect(Invoker<?> invoker, Invocation invocation,
		...
		try {
			...
			monitor.collect(new URL(Constants.COUNT_PROTOCOL, NetUtils
					.getLocalHost(), localPort, service + "/" + method,
